  ...
  Widget build(BuildContext context) {
    return SafeArea(child: SingleChildScrollView(
      child: Column(children: [
        Image.asset('assets/images/ic_launcher.png', height: 88.r, width: 88.r, fit: BoxFit.fill,),
        Text('v$_version'),
        Html(data: htmlContent,
          onLinkTap: (String? url,
              Map<String, String> attributes,
              element,) {
                RouteUtils.push(context, WebViewPage(loadResource: url ?? "", webViewType: WebViewType.URL, showTitle: true,));
          },),
      ],),
    ));
  }
