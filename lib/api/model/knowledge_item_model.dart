...
class KnowledgeListModel {
  List<KnowledgeItemModel>? list;
  
  KnowledgeListModel.fromJson(dynamic json) {
    list = [];
    for (var element in json) {
      list?.add(KnowledgeItemModel.fromJson(element));
    }
  }
}
class KnowledgeItemModel {
  ...
  KnowledgeItemModel.fromJson(dynamic json) {
    ...
    if (json['children'] != null) {
      ...
      json['children'].forEach((v) {
        children?.add(KnowledgeItemChildren.fromJson(v));
      });
    }
  ...
  String? author;
  List<KnowledgeItemChildren>? children;
  num? courseId;
  String? cover;
  String? desc;
  num? id;
...
class KnowledgeItemChildren {
  KnowledgeItemChildren({
      this.articleList, 
      this.author, 
      this.children, 
      this.courseId, 
  ...
  KnowledgeItemChildren.fromJson(dynamic json) {
    if (json['articleList'] != null) {
      articleList = [];
      json['articleList'].forEach((v) {
        articleList?.add(v);
