  ...
  HomeListModel.fromJson(Map<String, dynamic>? json) {
    ...
    if (json?['datas'] != null) {
      ...
      json?['datas'].forEach((v) {
        datas?.add(HomeListItemModel.fromJson(v));
      });
    }
    offset = json?['offset'];
    over = json?['over'];
...
class HomeTopListModel {
  List<HomeListItemModel>? dataList = [];

  HomeTopListModel.fromJson(dynamic json) {
    if (json is List) {
      for (var element in json) {
        dataList?.add(HomeListItemModel.fromJson(element));
      }
    }
  }
}
class HomeListItemModel {
  ...
  HomeListItemModel.fromJson(dynamic json) {
